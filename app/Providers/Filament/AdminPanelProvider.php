        ...
        return $panel
            ...
            ->renderHook('panels::head.end', fn (): string => <<<'CSS'
                <style>
                    ...
                    a[href*="/faculties"] .fi-sidebar-item-icon { color: rgb(59 130 246) !important; } /* Blue-500 */
                    ...
                    a[href*="/curriculums"] .fi-sidebar-item-icon { color: rgb(217 70 239) !important; } /* Fuchsia-500 */

                    /* Users */
                    a[href*="/students"] .fi-sidebar-item-icon { color: rgb(245 158 11) !important; } /* Amber-500 */
                    a[href*="/teachers"] .fi-sidebar-item-icon { color: rgb(16 185 129) !important; } /* Emerald-500 */
                    a[href*="/users"] .fi-sidebar-item-icon { color: rgb(107 114 128) !important; } /* Gray-500 */
                </style>
            CSS)
            ->navigationGroups([
