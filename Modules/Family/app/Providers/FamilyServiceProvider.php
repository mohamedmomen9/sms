...
class FamilyServiceProvider extends ServiceProvider
{
     ...
     * The module name.
     */
    protected string $moduleName = 'Family';

    /**
     * The module name in lowercase.
     */
    protected string $moduleNameLower = 'family';
     ...
     * \Modules\Family\Providers\FamilyServiceProvider::registerFilament($panel);
     */
    public static function registerFilament(Panel $panel): void
    {
        $panel->discoverResources(
            in: module_path('Family', 'app/Filament/Resources'),
            for: 'Modules\\Family\\Filament\\Resources'
        );
    }
    ...
    {
        return 'Modules\\Family\\Filament\\Resources';
    }
    ...
    {
        return module_path('Family', 'app/Filament/Resources');
    }
}
