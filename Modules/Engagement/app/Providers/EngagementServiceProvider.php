...
class EngagementServiceProvider extends ServiceProvider
{
     ...
     * \Modules\Engagement\Providers\EngagementServiceProvider::registerFilament($panel);
     */
    public static function registerFilament(Panel $panel): void
    {
        $panel->discoverResources(
            in: module_path('Engagement', 'app/Filament/Resources'),
            for: 'Modules\\Engagement\\Filament\\Resources'
        );
    }
    ...
    {
        return 'Modules\\Engagement\\Filament\\Resources';
    }
    ...
    {
        return module_path('Engagement', 'app/Filament/Resources');
    }
}
