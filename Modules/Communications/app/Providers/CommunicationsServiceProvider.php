...
class CommunicationsServiceProvider extends ServiceProvider
{
     ...
     * The module name.
     */
    protected string $moduleName = 'Communications';

    /**
     * The module name in lowercase.
     */
    protected string $moduleNameLower = 'communications';
     ...
     * \Modules\Communications\Providers\CommunicationsServiceProvider::registerFilament($panel);
     */
    ...
    {
        return 'Modules\\Communications\\Filament\\Resources';
    }
    ...
    {
        return module_path('Communications', 'app/Filament/Resources');
    }
}
